...
describe('application_layer/phones/delete', function() {
  ...
  describe('delete phone', function() {
    it('fails if input id invalid', async function() {
      ...
      expect(
        applicationLayer.phones.delete.parseInputParameters(invalidRequest)
      ).to.throw;
    });
    ...
    it('returns the deleted phone id if valid id provided', async function() {
      ...
      const actual = await applicationLayer.phones.delete.parseInputParameters(validRequest);
